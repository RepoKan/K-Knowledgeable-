...
Use `docs/` for architecture specifications, repository and free-tier design, governance contracts, source-authority and evidence rules, inspection workflows, connector and automation guidance, public operational runbooks, and sanitized engineering research.
